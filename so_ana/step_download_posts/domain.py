...
from so_ana_doc_worker.schemas import PageRawData, DownloadPageResult, DownloadPageFullResult, PostRawData, \
    DownloadPostResult, DownloadPostFullResult, PostMetaData, ExtractResult, ExtractFullResult
